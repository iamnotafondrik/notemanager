...
public class FirebaseStorageHelper {
    ...
    public FirebaseStorageHelper(Activity activity) {
        ...
        filePath = String.format("%s", context.getDatabasePath(DBHelper.DATABASE_NAME).getAbsolutePath());
    ...
    public void removeDatabase() {
        ...
        storageReference.child(filePath).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(context, "Database removed from Firebase Storage", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(context, "Database NOT removed from Firebase Storage", Toast.LENGTH_SHORT).show();
            }
        });
    }
