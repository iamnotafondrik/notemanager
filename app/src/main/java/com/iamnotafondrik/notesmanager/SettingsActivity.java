...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderSpinner = (Spinner) findViewById(R.id.remind_spinner);
    ...
    public void configSpinner() {
        String[] items = {getString(R.string.remind_half),
                getString(R.string.remind_one), getString(R.string.remind_two),
                getString(R.string.remind_three), getString(R.string.remind_eight)};
        ...
        reminderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    SPHelper.setLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY, 1800000);
                }
                if (position == 1) {
                    SPHelper.setLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY, 3600000);
                }
                if (position == 2) {
                    SPHelper.setLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY, 7200000);
                }
                if (position == 3) {
                    SPHelper.setLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY, 10800000);
                }
                if (position == 4) {
                    SPHelper.setLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY, 28800000);
                }
            }
        ...
        long remindDelay =SPHelper.getLongPreference(SPHelper.PREFS_NOTE_MANAGER_REMIND_DELAY);
        if (remindDelay == 1800000) {
            reminderSpinner.setSelection(0);
        } else if (remindDelay == 3600000) {
            reminderSpinner.setSelection(1);
        } else if (remindDelay == 7200000) {
            reminderSpinner.setSelection(2);
        } else if (remindDelay == 10800000) {
            reminderSpinner.setSelection(3);
        } else if (remindDelay == 28800000) {
