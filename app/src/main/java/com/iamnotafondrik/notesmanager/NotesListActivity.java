...
public class NotesListActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    DBHelper dbHelper;
    String[] noteId, description, date, pinned, remind;
    int[] group;
    TextView noNoteText;
    ...
    private void loadFormDB(String column) {
        ...
        remind = new String[cursor.getCount()];
        ...
        if (cursor.moveToFirst()) {
            ...
            int remindIndex = cursor.getColumnIndex(DBHelper.KEY_REMIND);
            do {
                ...
                remind[cursor.getPosition()] = cursor.getString(remindIndex);
        ...
        for (String tmpDescription : description) {
            ...
            Note note = new Note(noteId[count], tmpDescription, dateFormated, group[count], pinned[count], remind[count]);
